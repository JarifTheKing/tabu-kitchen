...
const ReadyCookingCard = ({order}) => {
  ...
  return (
    <div className="p-5 rounded-xl shadow-xl relative space-y-3">
      ...
      {/* Real Time */}
      <div className="mt-3 text-xs">
        <h4 className="text-primary font-bold text-sm">Cooked Time: <span className="text-amber-600"> {order.cookedTime}
          </span></h4>
      </div>
...
export default ReadyCookingCard;